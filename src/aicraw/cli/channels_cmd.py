...
# Template for `aicraw channels install <key>` stub (channel key substituted).
...
from aicraw.app.channels.base import BaseChannel
from aicraw.app.channels.schema import ChannelType
...
def list_cmd() -> None:
    ...
    if not config_path.is_file():
        ...
        click.echo("Run `aicraw channels config` to create one.")
        cfg = load_config()
    else:
