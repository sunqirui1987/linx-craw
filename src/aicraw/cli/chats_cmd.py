...
def chats_group() -> None:
    ...
    \b
    Common examples:
      aicraw chats list                    # List all chats
      aicraw chats list --user-id alice    # Filter by user
      aicraw chats get <chat_id>           # View details
      aicraw chats create --session-id s1 --user-id u1
      aicraw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      aicraw chats list
      aicraw chats list --user-id alice
      aicraw chats list --channel discord
      aicraw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `aicraw chats list`.

    \b
    Examples:
      aicraw chats get 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
...
def create_chat(
    ...
    Inline creation examples:
      aicraw chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      aicraw chats create -f chat.json
    """
    base_url = _base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      aicraw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
...
def delete_chat(
    ...
    \b
    Examples:
      aicraw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
